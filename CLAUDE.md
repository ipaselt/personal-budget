...
- 🧹 **DB is a clean 2026 slate for real data**: 0 txns / 0 accounts / 0 budgets / 0 archived, `active_year=2026`. Sample + real-data backups in `data/budget.*-backup-*.db` (gitignored). Owner imports their real CSV next.
